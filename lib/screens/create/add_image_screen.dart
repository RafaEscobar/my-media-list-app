  ...
  Future<void> _pickImage(ImageSource source) async {
    try {
      ...
      if (null != pickedImage) {
        ...
        if (mounted) context.read<MediaProvider>().mediaImage = image;
                ...
                children: [
                  Column(
                    children: [
                      ...
                      RoundImage(imageFilePath:_selectedImage! , width: 200, height: 200, type: 'file', borderRadius: BorderRadius.circular(70),)
                    ],
                  ),
                  Column(
                    children: [
